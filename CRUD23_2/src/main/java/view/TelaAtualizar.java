...
public class TelaAtualizar extends javax.swing.JFrame {
    ...
    public void mostarTarefa(){
        ...
        lblMostrarId.setText(Integer.toString(tarefa.getId()));
    ...
    private void btnConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConfirmarActionPerformed
       ...
       tarefa.setId(Integer.parseInt(lblMostrarId.getText()));
       tarefa.setDescricao(txtDescricao.getText());
       tarefa.setLocal(txtLocal.getText());
       
       tdao.atualizarTarefa(tarefa);
